...
function Movies() {
  ...
  return (
    <div>
      ...
      <div className="flex space-x-5 justify-around my-5">
        <button disabled={pageNumber === 1} className={pageNumber === 1 ? "cursor-not-allowed" : "cursor-pointer hover:scale-110 hover:shadow-black hover:shadow-2xl"} onClick={handelPrev}>Previous</button>
        <button className="cursor-pointer hover:scale-110 hover:shadow-black hover:shadow-2xl" onClick={handelNext}>Next</button>
      </div>
    </div>
  );
}
